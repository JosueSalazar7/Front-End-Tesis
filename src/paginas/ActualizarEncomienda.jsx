...
const ActualizarEncomienda = () => {
    ...
    return (
        <>
            <div>
                <h1 className="font-black text-4xl text-gray-500">Actualizar Encomienda</h1>
                <hr className="my-4" />
                <p className="mb-8">Completa los datos para actualizar el estado de la encomienda</p>
            </div>
            <div>
                <form onSubmit={handleSubmit} className="m-5">
                    ...
                    <div className="mb-4">
                        <label htmlFor="estadoPaquete" className="block text-md text-gray-600 uppercase font-bold">Estado de la encmienda</label>
